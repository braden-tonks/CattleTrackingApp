...
android {
    namespace = "com.example.cattletrackingapp"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.example.cattletrackingapp"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
        ...
        buildConfigField("String", "GEMINI_API_KEY", "\"${properties.getProperty("GEMINI_API_KEY", "")}\"") // ← add this
